...
const itemsDaModificareService = require('../services/ItemsDaModificare.service');
...
router.get(`/`, async (req, res) => {
  try {
    const itemsDaModificareNewVariable = itemsDaModificareService.getAllItems();
...
router.get(`/:id`, async (req, res) => {
  try {
    const singleItemDaModificareNewVariable = await itemsDaModificareService.getItemById(
      req.params.id,
    );
...
router.post(`/`, async (req, res) => {
  try {
    const singleItemDaModificareNewVariable = await itemsDaModificareService.createItem(req.body);
...
router.put(`:/id`, async (req, res) => {
  try {
    const singleItemDaModificareNewVariable = await itemsDaModificareService.updateItemById(
      req.params.id,
      req.body,
    );
...
router.delete(`/:id`, async (req, res) => {
  try {
    await itemsDaModificareService.deleteItemById(req.params.id);
